...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if(!_context || ![EAGLContext setCurrentContext:_context] || ![self loadShader]) {
            return nil;
        }
...
-(BOOL)loadShader {
    ...
    //vertShader，fragShader 可以理解为一个方法的指针，或者一堆连续的内存
